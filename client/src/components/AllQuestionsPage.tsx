      ...
      <div className="px-4 py-6 sm:px-0">
        ...
        {error && (
          <div className="bg-red-50 p-4 rounded-md">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-red-800">Failed to load questions</h3>
        ...
        {!isLoading && questions && questions.length === 0 && (
          <div className="bg-white shadow overflow-hidden rounded-md px-6 py-10 text-center">
            ...
            <p className="mt-2 text-gray-500">No questions posted yet. Be the first to ask a question!</p>
          </div>
        )}
